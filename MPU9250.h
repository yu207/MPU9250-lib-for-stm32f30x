...
#define AK8963_CNTL2		 0x0B	 // AK8963 control 2
...
#define MAG_LSB_BPUT        0.315f    // Magnetic Sensitivity in Bits / micro-Tesa (uT)  10.*1229./4096.; // Conversion from 1229 microTesla full scale (4096) to 12.29 Gauss full scale
...
extern void MPU9250_Read_Acc(float *x, float *y, float *z);
extern void MPU9250_Read_Gyro(float *x, float *y, float *z);
extern void MPU9250_Read_Mag(float *x, float *y, float *z);
